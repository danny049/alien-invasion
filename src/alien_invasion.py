...
# Used sys module for quitting the game.
import pygame
...
class AlienInvasion:
    """Class to manage overall game behaviour and assets"""

    def __init__(self):
        """Initialise the game and create class resources. The below method makes pygame work properly""" 
        pygame.init()
    ...
    def _check_aliens_bottom(self):
        ...
        for alien in self.aliens.sprites():
            if alien.rect.bottom >= screen_rect.bottom:
                # Treat the the same as if the ship got hit
                self._ship_hit()
                break
            
    def _check_events(self):
        # This is the part that keeps track of keyboard and mouse events
    ...
    def _update_screen(self):
        # Redraw the screen with the right colour
